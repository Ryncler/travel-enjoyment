<template>
    ...
    <el-row>
        ...
        <el-col :span="3" class="useroptions" :offset="18">
            <el-button round type="primary" class="revertbtn" @click="goAddUser()">新增角色</el-button>
...
import { getAllRole, deleteRole } from '@/api/user/role';
...
const getRoleData = () => {
    ...
    return getAllRole(parms).then(res => {
        if (res.status === 200) {
